...
const TripStatusTab = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (origin && destination && journeyDate && totalPassengers) {
      ...
      const url = `/book/home/trip/status?origin=${origin.value}&destination=${destination.value}&date=${formattedDate}`;
      ...
      <div>
        ...
        <div style={{ display: "flex", marginBottom: "20px" }}>
          ...
          <div
            ...
            onClick={handlePassengerBoxClick}
          >
