  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('../assets/call.jpg')" }}>
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
          <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
            Habesha Bus Bridging Cultures, Connecting Communities
          </h1>
          <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
            Embark on a journey with Habesha Bus, where tradition meets
            modernity, and every ride is a celebration of Ethiopia's rich
            heritage.
          </p>
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <h1 class="text-gray-900 dark:text-white text-xl md:text-3xl font-extrabold mb-2 text-center">
            Prepare For Your Trip
          </h1>
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6 text-center">
            Considering a trip in the near future? Explore these choices to
            begin your journey
          </p>
        </div>
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">
              How to Quickly Book Habesha Bus Using Our Website
            </h1>
            <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">
              Experience seamless booking with Habesha Bus. Find routes, choose
              times, and secure your seat hassle-free online.
            </p>
            <a
              href="#"
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              ...
              <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                Where will your next unforgettable journey begin? Explore the
                extensive and diverse selection of destinations awaiting you
                with Habesha Bus.
              </p>
              <a
                href="#"
            ...
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              ...
              <img className="w-40" src="../assets/bus.webp" alt="go" />
              <h2 class="text-gray-900 dark:text-white text-2xl font-bold mb-2">
                Contact Our Call Center
              </h2>
              <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                Our call center is available 24/7 to assist with booking,
                reservations, ticket changes, and any travel-related questions.
              </p>
              <a
                href="#"
                class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center"
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Our call center is available 24/7 to assist with booking,
                  reservations, ticket changes, and any travel-related
                  questions.
                </p>
                <a
                  href="#"
